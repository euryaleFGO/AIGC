...
#更新工作流
def update_workflow(workflow_data, prompt_positive,prompt_negative,random_seed,width=832,height=1216):
    workflow_data["6"]["inputs"]["text"] = prompt_positive
    workflow_data["7"]["inputs"]["text"] = prompt_negative
    workflow_data["3"]["inputs"]["seed"] = random_seed
...
def workflow_result(url, workflow_id):
    ...
    print(images)
    image_info_list = images["9"]["images"]
...
def inference(url, workflow_data,prompt_positive,prompt_negative,random_seed,width=832,height=1216):
    workflow_data = update_workflow(workflow_data, prompt_positive,prompt_negative,random_seed,width,height)
...
if __name__ == '__main__':
    ...
    workflow_path = "workflow\AnimeAPI.json"
    ...
    inference(url, workflow_data,prompt_positive,prompt_negative,random_seed)
